  ...
  */
  ...
  function Fly() {
    ...
    plugins.forEach(function (_ref2) {
      ...
      return plugin.call(_this, (0, _debug2["default"])(name.replace("-", ":")), _("load %o", name));
    });
  }
  ...
  _createClass(Fly, [{
    ...
    value: function source() {
      ...
      _Object$assign2(this, { _: { write: _write2["default"], filters: [], globs: (0, _flyUtil.flatten)(globs) } });
    ...
    value: function filter(name, cb) {
      if (name instanceof Function) this.filter({ cb: name });else if (typeof name === "object") this._.filters.push(name);else {
        ...
        this[name] = function (options) {
          (0, _debug2["default"])("fly")(name + " %o", options);
          return this.filter({ cb: cb, options: options });
        };
      }
      return this;
    }
    ...
    value: function unwrap(onFulfilled, onRejected) {
      ...
      return new _Promise(function (resolve, reject) {
        return _Promise.all(_this3._.globs.map(function (glob) {
          ...
          return resolve.apply(_this3, files);
        })["catch"](reject);
    ...
    */
    ...
    value: function concat(base) {
      this._.catenator = new _concatWithSourcemaps2["default"](true, base, "\n");
      this._.write = _regeneratorRuntime.mark(function callee$2$0(_ref4) {
        var dir = _ref4.dir;
        var data = _ref4.data;
        var map = _ref4.map;
        return _regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
              context$3$0.next = 2;
              return (0, _write2["default"])({ dir: dir, base: base, data: data, map: map, write: _mzFs.appendFile });
    ...
    value: function target() {
      for (var _len3 = arguments.length, dirs = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        dirs[_key3] = arguments[_key3];
      }

      return _co2["default"].call(this, _regeneratorRuntime.mark(function callee$2$0() {
        var _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _loop, _iterator2, _step2, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5;
                ...
                return _regeneratorRuntime.wrap(function callee$3$0$(context$4$0) {
                  while (1) switch (context$4$0.prev = context$4$0.next) {
                    ...
                    case 16:
                      ...
                      concat = this._.catenator || new _concatWithSourcemaps2["default"](true, base, "\n");
                    ...
                    case 23:
                      ...
                      filter = _step4.value;
                      context$4$0.next = 27;
                      return _Promise.resolve(filter.cb.call(this, data, _Object$assign2({ filename: base }, filter.options)));
                    ...
                    case 53:
                      ...
                      return this._.write({
                        dir: dir, data: data,
                        base: _path.join.apply(undefined, _toConsumableArray((0, _path.parse)(file).dir.split(_path.sep).filter(function (path) {
                    ...
                    case 62:
                      context$4$0.prev = 62;
                      context$4$0.t2 = context$4$0["catch"](51);
                      _didIteratorError5 = true;
                      _iteratorError5 = context$4$0.t2;
                    ...
                    case 79:
                      context$4$0.prev = 79;
                      context$4$0.t3 = context$4$0["catch"](4);
                      _didIteratorError3 = true;
                      _iteratorError3 = context$4$0.t3;
                    ...
                    case 89:
                      return context$4$0.finish(86);

                    case 90:
                      return context$4$0.finish(83);

                    case 91:
                    case "end":
                      return context$4$0.stop();
                  }
                }, callee$3$0, _this6, [[4, 79, 83, 91], [21, 36, 40, 48], [41,, 43, 47], [51, 62, 66, 74], [67,, 69, 73], [84,, 86, 90]]);
              });
